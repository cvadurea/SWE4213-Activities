...
- [x] `curl http://localhost:4000/videos` returns the video list directly from the catalog
- [x] `curl http://localhost:4002/videos` returns the same list via the gateway
- [x] The gateway logs show it is connecting to the catalog service
